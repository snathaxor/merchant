...
class GenerateReportsWhite extends StatefulWidget {
  const GenerateReportsWhite({
    Key? key,
  }) : super(key: key);
  @override
  _GenerateReportsWhite createState() => _GenerateReportsWhite();
}

class _GenerateReportsWhite extends State<GenerateReportsWhite> {
  _GenerateReportsWhite();
