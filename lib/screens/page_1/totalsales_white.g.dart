...
class TotalsalesWhite extends StatefulWidget {
  const TotalsalesWhite({
    Key? key,
  }) : super(key: key);
  @override
  _TotalsalesWhite createState() => _TotalsalesWhite();
}

class _TotalsalesWhite extends State<TotalsalesWhite> {
  _TotalsalesWhite();
      ...
      child: Stack(children: [
        ...
        Positioned(
          ...
          child: Container(
              ...
              height: 17.000,
              child: AutoSizeText(
                'know in detail about your sales.',
                style: TextStyle(
                  fontFamily: 'Poppins',
                  fontSize: 11,
                  fontWeight: FontWeight.w400,
